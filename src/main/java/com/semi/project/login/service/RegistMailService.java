...
import com.semi.project.login.repository.MailRepository;

@Service
public class RegistMailService implements MailRepository {
...
//		System.out.println("인증 번호 : " + ePw);
		...
		message.setSubject("DOBEBEST 회원가입 이메일 인증");// 제목
